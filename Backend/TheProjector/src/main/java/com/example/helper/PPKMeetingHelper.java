...
public class PPKMeetingHelper {
    ...
    public static ByteArrayInputStream generatePPKPresentation()
        ...
        try(XMLSlideShow generiertePowerPointPraesentation = new XMLSlideShow()) {
            ...
            nextPPKMeeting_r.setText("Projekt Portfolio Komitee ( " +ppk.getNextPPK() +" )");
            ...
            byte[] ersteSeite = IOUtils.toByteArray(new FileInputStream("/Users/anabikic/Documents/SCHULE/5BHITM/Diplomarbeit/apachePOI_try/src/main/img/firstPicture.png"));
            ...
            for(int generate = 0; generate < projekteanzahl; generate++){
                ...
                cell_projektprotfolio_status_r.setText(""+allProjects.get(generate).getStatus());
                ...
                cell_projektprotfolio_startdatum_r.setText(""+allProjects.get(generate).getStart_datum());
                ...
                cell_projektprotfolio_planfertigstellung_r.setText("" + allProjects.get(generate).getEnd_datum());
            ...
            projektportfolio_footer_r.setText("Projekt Portfolio Komitee ( " +ppk.getNextPPK() +" )");
            ...
            for(int i = 0; i < projekteanzahl; i++) {
                ...
                einsatzpunkt_r.setText(""+allProjects.get(i).getEnd_datum());
                ...
                softwareanforderungsfolie_footer_r.setText("Projekt Portfolio Komitee ( " +ppk.getNextPPK()+" )");
            ...
            for(int i = 0; i < allBeschluss.size(); i++) {
                    ...
                    //pic1
                    byte[] aenderungsVorschlag = IOUtils.toByteArray(new FileInputStream("/Users/anabikic/Documents/SCHULE/5BHITM/Diplomarbeit/apachePOI_try/src/main/img/aenderung.png"));
                    ...
                    //pic2
                    byte[] empfehlung = IOUtils.toByteArray(new FileInputStream("/Users/anabikic/Documents/SCHULE/5BHITM/Diplomarbeit/apachePOI_try/src/main/img/play.png"));
                    ...
                    footer_r.setText("Projekt Portfolio Komitee ( " + ppk.getNextPPK() + " )");
            ...
            //FOOTER
                ...
                projektuebersichtsfolie_footer_r.setText("Projekt Portfolio Komitee ( " +ppk.getNextPPK()+ " )");
            ...
            byte[] status3 = IOUtils.toByteArray(new FileInputStream("/Users/anabikic/Documents/SCHULE/5BHITM/Diplomarbeit/apachePOI_try/src/main/img/status1.png"));
            XSLFPictureData status3_pd = generiertePowerPointPraesentation.addPicture(status3, PictureData.PictureType.PNG);
            XSLFPictureShape status3_pic = projektuebersichtsFolie.createPicture(status3_pd);
            status3_pic.setAnchor(new Rectangle(150,440,50,50));
            ...
            byte[] status2 = IOUtils.toByteArray(new FileInputStream("/Users/anabikic/Documents/SCHULE/5BHITM/Diplomarbeit/apachePOI_try/src/main/img/status2.png"));
            XSLFPictureData status2_pd = generiertePowerPointPraesentation.addPicture(status2, PictureData.PictureType.PNG);
            XSLFPictureShape status2_pic = projektuebersichtsFolie.createPicture(status2_pd);
            status2_pic.setAnchor(new Rectangle(135,365,80,60));
            ...
            byte[] status = IOUtils.toByteArray(new FileInputStream("/Users/anabikic/Documents/SCHULE/5BHITM/Diplomarbeit/apachePOI_try/src/main/img/status1.png"));
            XSLFPictureData status_pd = generiertePowerPointPraesentation.addPicture(status, PictureData.PictureType.PNG);
            XSLFPictureShape status_pic = projektuebersichtsFolie.createPicture(status_pd);
            status_pic.setAnchor(new Rectangle(150,215,50,50));
            ...
            cell_termine_kommentar.setText(""+allProjects.get(a).getStart_datum()+", "+allProjects.get(a).getEnd_datum());
